...
const PROFILES = [
  {
    ...
    permissions: [
      ...
      { label: "Pautas (criar, editar, excluir)", allowed: true },
  ...
  },
  {
    ...
    description: "Gerencia equipe, equipamentos, pautas, saídas e devoluções. Sem acesso a configurações.",
    permissions: [
      { label: "Dashboard", allowed: true },
      { label: "Pautas (criar, editar, excluir)", allowed: true },
      { label: "Equipe (criar, editar, excluir)", allowed: true },
  ...
  },
  {
    ...
    description: "Visualiza pautas, equipe e equipamentos. Pode revisar saídas e devoluções.",
    permissions: [
      { label: "Dashboard", allowed: true },
      { label: "Pautas (somente leitura)", allowed: true },
      ...
      { label: "Criar/editar pautas", allowed: false },
